...
% best chi:
% high:
%     0.4023    0.4237    3.5768    0.1792    0.0287


% low:
%     0.2930    0.6317    2.5403    0.1919    0.1207 (0.8745)
...
figure(3); hold on;
doses = [25,50,12.5,25];
plot(doses,chi(1:4),'.k','MarkerSize',20);hold on;
plot(doses(1:2),chi(1:2),'-k','LineWidth',1);hold on;
plot(doses([1,3]),chi([1,3]),'-k','LineWidth',1);hold on;
plot(doses([3,4]),chi([3,4]),'-k','LineWidth',1);hold on;
plot(doses([2,4]),chi([2,4]),'-k','LineWidth',1);hold on;
xlabel('dose (mg)');
ylabel('model-pred. kill rate');
