...
printPNG(figure(20),strcat('plot/',num2str(BD),'-DR-high.png'));
figure(21); hold on; plotDIPErrorBars(DIP_all);
printPNG(figure(21),strcat('plot/',num2str(BD),'-DR-low.png'));
...
function []=plotEC50Violin(EC50vec)
    ...
    EC50vecT = [EC50vec(:,3),EC50vec(:,1),EC50vec(:,4),EC50vec(:,2)];
    ...
    xticklabels({'UH','EH','UL','EL'});

    ylim([0 1000])
    addSignificance(EC50vecT,[0,1000])
